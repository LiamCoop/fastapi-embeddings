    ...
    <div className="flex h-full flex-col px-8 py-8 gap-6">
      ...
      <div className="flex flex-1 gap-6 min-h-0">
        <div className="flex flex-1 flex-col gap-4">
          ...
          <div className="flex-1 rounded-xl border border-border bg-card p-6">
            ...
            <div className="mt-4 rounded-lg border border-dashed border-border py-16 text-center">
              ...
              <p className="mt-1 text-xs text-muted-foreground/40">With grounding and chunk citations</p>
            </div>
          </div>
        </div>
        ...
        <div className="w-80 shrink-0 space-y-4">
          ...
          <div className="rounded-xl border border-border bg-card p-5">
            <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Retrieved Chunks</p>
